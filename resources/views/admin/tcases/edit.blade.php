            ...
            <div class="sm:grid grid-cols-2 gap-x-4">
                ...
                <div>
                    ...
                    <div class="relative mb-4">
                        ...
                        <input name="date" :value="$tcases->date" id="date" type="date" class="border border-gray-300 text-gray-900 text-xs 2xl:text-sm rounded-lg focus:ring-primary focus:border-primary block w-full pl-10 p-3 mb-1.5" placeholder="Pilih tanggal mulai" autocomplete="off">
                    </div>
