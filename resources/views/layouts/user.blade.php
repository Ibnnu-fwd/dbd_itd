                ...
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1"
                        ...
                        <ul class="flex flex-col mt-4 lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <a href="/"
                                    class="block py-2 pr-4 pl-3 text-primary rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 text-xs 2xl:text-sm">Beranda</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0  text-xs 2xl:text-sm">Vektor</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 text-xs 2xl:text-sm">Larva</a>
                            </li>
                            <li class="lg:hidden">
                                @if (auth()->check())
                                    <form action="{{ route('logout') }}" method="POST">
